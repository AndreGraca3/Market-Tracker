...
{
    public async Task<IEnumerable<ListOfProducts>> GetListsOfProductsAsync(Guid? clientId = null, string? listName = null, DateTime? archivedAt = null)
    {
        ...
        if (listName != null)
        {
            query = query.Where(l => l.Name == listName);
        }
