...
public class StoreControllerTest
{
    ...
    public async Task GetStoresFromCompanyAsync_ReturnsOk()
    {
        ...
        _storeServiceMock
            ...
            .ReturnsAsync(EitherExtensions.Success<IServiceError, IEnumerable<Store>>(stores));
    ...
    public async Task GetStoresFromCompanyAsync_ReturnsNotFound()
    {
        ...
        _storeServiceMock
            ...
            .ReturnsAsync(
                EitherExtensions.Failure<IServiceError, IEnumerable<Store>>(
    ...
    public async Task AddStoreAsync_ReturnsOk()
    {
        ...
        _storeServiceMock
            ...
            .ReturnsAsync(EitherExtensions.Success<IServiceError, IdOutputModel>(idOutputModel));
